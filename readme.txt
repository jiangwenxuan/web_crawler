（预约实验设备的代码是love.py，为了运行我写的快速预约实验设备的代码，需要用pip（或anaconda）安装一些模块，具体安装什么详见我的代码头部。）
...
2.处理验证码：处理验证码可以用别人的代码，但是想要进一步了解的话，需要计算机视觉的知识，如果很感兴趣的话，可以慢慢入门计算机视觉。不妨从《数字图像处理》开始，一点一点学习，每学期学一门课。
